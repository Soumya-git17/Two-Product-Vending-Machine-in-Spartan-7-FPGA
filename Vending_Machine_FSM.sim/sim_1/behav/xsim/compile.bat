...
REM
REM Generated by Vivado on Mon Apr 06 14:54:16 +0530 2026
...
echo "xvlog --incr --relax -prj Vending_machine_top_tb_vlog.prj"
call xvlog  --incr --relax -prj Vending_machine_top_tb_vlog.prj -log xvlog.log
